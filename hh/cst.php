...
<script language="JavaScript">
    function validateForm()
	{
		...
		if (x2==null || x2=="")
  			{
  				alert("يجب إضافة تاريخ الإستلام");
  				return false;
  			}
}
  </script>
...
<FORM NAME="FORM1"  action="http://localhost/cst1.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()" >
...
<TH><FONT size='4'  >تاريخ الإستلام: </TH><TH align="right">	
	<input type="text" style="font-size: 10pt; padding-top:5px;height:25 px;width:70 px" name="date1" />
...
<TH><FONT size='4'  >تاريخ المكاتبة: </TH><TH align="right">
	...
	<input type="text" style="font-size: 10pt; padding-top:5px;height:25 px;width:70 px" name="date2" />
...
<TH><FONT size='4'  >تاريخ التحويل:</TH><TH align="right">
	...
	<input type="text" style="font-size: 10pt; padding-top:5px;height:25 px;width:70 px" name="date3" />
