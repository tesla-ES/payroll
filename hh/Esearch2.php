...
<FORM NAME="FORM1"  action="http://localhost/Elist3.php?start=0" method="post">
...
<option value="1">صادر الرئاسة</option>
<option value="2">صادر مراكز الخدمة</option>
<option value="3">صادر الأنشطة الرياضية</option>
<option value="4">جهات أخرى</option>
</select></TH>
</TR>

<TR  align="middle">
<TH><FONT size='4'  >المرسل إليه :</TH><TH align="right"><INPUT TYPE="TEXT" NAME="Text5" style="font-size: 10pt; padding-top:5px;height:25 px;width:200 px" value=""></TH>
</TR>

<TR  align="middle">
<TH><FONT size='4'  > جهة الإرسال :</TH><TH align="right"><INPUT TYPE="TEXT" NAME="Text6" style="font-size: 10pt; padding-top:5px;height:25 px;width:200 px" value=""></TH>
</TR>
...
<TR  align="middle">
<TH><FONT size='4'  >الراسل :</TH><TH align="right"><select name="Text8" style="font-size: 10pt; padding-top:5px;height:25 px;width:200 px">
<option value="0"> </option>
