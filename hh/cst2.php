...
if(!($start>=$record_count-$per_page)){
	...
	echo " <a href='cst2.php?start=$last_rec'><img src='img/lastpage.gif' alt='Last Page'></a>";
	/////////////getting the next page
echo " <a href='cst2.php?start=$next'><img src='img/nextpage.gif' alt='Next Page'></a>";

}
  //show prev button
if(!($start<=0)){ //////////////////getting previous page
echo " <a href='cst2.php?start=$prev'><img src='img/backpage.gif' alt='Previous Page'></a>";
/////////////getting the first page
echo " <a href='cst2.php?start=0'><img src='img/first.gif' alt='First Page'></a>";
}
